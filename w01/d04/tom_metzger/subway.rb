...
#THIS CODE CALCULATES DISTANCE BETWEEN 2 STATIONS ON DIFFERENT LINES, however it is specific to the particular problem and hard-coded values need to be remvoed and replace with proper variables, methods, and calculations to provide necessary flexibility
